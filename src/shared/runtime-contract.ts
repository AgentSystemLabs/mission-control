...
export const FILE_WRITE_ERRORS = ["invalid-path", "invalid-content", "stale", "too-large", "unknown-project"] as const;
...
export type RuntimeBridge = {
  ...
  pty: {
    ...
    write: (ptyId: string, data: string, projectId?: string) => Promise<boolean>;

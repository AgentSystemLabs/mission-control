...
export function MemorySettingsPage() {
  ...
  return (
    <>
      <SettingsSection
        title="Recall"
        subtitle="Project memory Mission Control builds and hands to each new session."
        headingLevel="h1"
      >
        <ToggleRow
      ...
      <SettingsSection
        title="Recall engine"
        subtitle="The CLI that distills sessions and refines briefs, in print mode — the same harness choices as a new session. Turn it off to fall back to deterministic ranking with no CLI round-trip."
      >
        <ToggleRow

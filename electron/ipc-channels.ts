export const IPC = {
  ...
  petOverlayGetState: "petOverlay:get-state",
  petOverlaySetEnabled: "petOverlay:set-enabled",
  petOverlaySetInteractive: "petOverlay:set-interactive",
  petOverlayStateChange: "petOverlay:state-change",
  petOverlayPushMirror: "petOverlay:push-mirror",
  petOverlayGetMirror: "petOverlay:get-mirror",
  petOverlayMirrorEvent: "petOverlay:mirror-event",
  petOverlayAction: "petOverlay:action",
  petOverlayActionEvent: "petOverlay:action-event",

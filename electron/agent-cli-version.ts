...
import { compareCliVersions, extractCliVersion } from "../src/shared/agent-cli-version-compare";
import { buildCmdScriptCommand, isWindowsCommandScript } from "./windows-cmd";

export { compareCliVersions, extractCliVersion } from "../src/shared/agent-cli-version-compare";
